...
{
    public static class KafkaProvider
    {
        public static Consumer<long, string> GetConsumer(string brokerList, string connStr, string consumergroup, string topic,
            string cacertlocation)
        {
            ...
            var consumer = new Consumer<long, string>(config, new LongDeserializer(), new StringDeserializer(Encoding.UTF8));
